...
/*                                                                   */         
/*********************************************************************/         
LASTUPD = '10/15/2025'                       /* date of last update  */         
/*********************************************************************/         
/*                                                                   */         
...
Else do  /* JES2 */                                                             
  ...
  Select                                                                        
    When Substr(JESLEV,1,8) == 'z/OS 3.1' then, /* z/OS 3.1          */         
      JESNODE  = Strip(Storage(D2x(JESSUS2+704),8)) /* JES2 NODE     */         
    When Substr(JESLEV,1,8) == 'z/OS 2.5' | ,   /* z/OS 2.5          */         
      Substr(JESLEV,1,8) == 'z/OS 2.4'  then,   /* z/OS 2.4          */         
...
End                                                                             
If Bitand(CVTOSLV6,'02'x) = '02'x then do    /* z/OS 3.1  and above  */         
   IPAPDETB.NUM = 'RSM'      ; NUM = NUM + 1                                    
End                                                                             
 /*                                                                             
If Bitand(CVTOSLV6,'01'x) = '01'x then do    /* z/OS 3.2  and above  */         
   /* z/OS 3.2 code here */                                                     
End                                                                             
 */                                                                             
IPAPDETB.0 = NUM-1                                                              
